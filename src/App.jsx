    ...
    <>
      ...
      {showContent && (
        <div className="main w-full rotate-[-10deg] scale-[1.7]">
          ...
          <div className="w-full h-260 flex items-center justify-center bg-black">
            <div className="cntnr flex text-white w-full h-[80%] ">
              <div className="limg relative w-1/2 h-full">
                <img
                  className="absolute scale-[1] top-100 left-1/2 -translate-x-1/2 -translate-y-1/2"
                  src="./imag.png"
                  alt=""
                />
              </div>
              <div className="rg w-[30%] py-7">
                ...
                <button className="bg-yellow-500 px-10 py-7 text-black mt-10 text-4xl">
                  Download Now
                </button>
              </div>
            </div>
